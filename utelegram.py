import ujson, ure, time, gc, urequests, uasyncio
...
class AsyncBot():
    '''
    Base class for interacting with telegram api with asyncio
    '''
    ...
    def __init__(self, token):
        ...
        uasyncio.run(self._get_updates())
    ...
    async def _get_updates(self):
        ...
        try:
            async with session.post(self.url + '/getUpdates', json=parameters) as response:
